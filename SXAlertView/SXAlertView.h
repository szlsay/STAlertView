...
typedef NS_OPTIONS(NSUInteger, SXAlertAnimationOptions) {
...
+ (void)showWithTitle:(nullable NSString *)title message:(nullable NSString *)message cancelButtonTitle:(nullable NSString *)cancelButtonTitle otherButtonTitle:(nullable NSString *)otherButtonTitle clickButtonBlock:(nullable void (^)(SXAlertView *alertView, NSUInteger buttonIndex))block;
